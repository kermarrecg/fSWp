...
%replace readtable(['DRAO_PWV.txt']) with the name of the file you want to process

LBpvalues=NaN(10,1); R2=NaN(10,1); SumCorr2=NaN(10,1);
mPar=NaN(8,1);Miss=NaN(10,1); vV=NaN(8,1);

jjj=1;
structData = readtable(['DRAO_PWV.txt']); ID=  'DRAO';
...
%     print(g1,strcat(ID,'Trend and CIs',string(jjj)),'-dpdf', '-fillpage', '-painters','-r600')
    ...
    disp(['The uncertainty of the trend is +-',string(sqrt(mVarBeta(2,2)))])
    %close all
